<x-layout title="Editar Item: {{ $compra->nome }}">
    ...
    <form action="{{ route('compras.update' , $compra->id) }}" method="POST" class="p-3 border rounded shadow-sm bg-light">
        @csrf
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input class="form-control" type="text" id="nome" name="{{$compra->nome}}"
                    placeholder="Ex.: Arroz, Feijão..." value="{{ old($compra->nome) }}" autofocus>
            </div>
